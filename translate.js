...
if (location.search == '?page=training') {
    $('.panel').html(`
<h2>训练</h2>
<p><b>新资源：</b> 学长们已经准备了一个新的训练平台： <a href="https://usaco.guide/">USACO Guide</a>。
<p>USACO的<a href="https://usaco.training">培训页面</a> 提供了数百个小时的免费指导和练习问题，帮助提高编程和问题解决能力。（注：我们正在迁移培训页面至新系统；与此同时，它们托管在我们的旧系统上，在这段时间内，全新的usaco.org用户账户无法被识别 —— 您可能需要创建一个单独的账户来访问培训页面。）</p>
<p>通过在线培训页面展现出实质性进步，并在我们的<a href="index.php?page=contests">在线编程比赛</a>中表现出色的学生，有资格被选为受邀参加USACO夏季<a href="index.php?page=camp">培训营</a>的决赛选手，进一步接受指导，并有可能被考虑为参加国际信息学奥林匹克竞赛（IOI）的美国代表团成员。</p>`)
}
...
<p><b>新资源：</b>学长们已经准备了一个新的训练平台： <a href="https://usaco.guide/">USACO Guide</a>。这对于任何想要在USACO中取得成功的人来说，看起来都是一个极佳的网站！
...
League</a>，在湾区，<a href="https://alphastar.academy/">Alpha Star Academy</a>，<a href="https://x-camp.academy">X-Camp Academy</a>，<a href="https://www.whizkidzcc.com">WhizKidz Computer Center</a>，<a href="https://ascendankelearning.com/">Ascende Learning</a>，在北弗吉尼亚，<a href="https://www.absoluteacademy.net/">绝对学院</a>提供了基于USACO课程的课程。Prof. Rajiv
...
训练的在线<a href="https://usacocoach.com">课程</a>，以及一家名为<a href="https://breakoutmentors.com/usaco-competitive-programming-academy/">Breakout Mentors</a>的CS辅导公司也提供USACO特训课程。USACO赞助商<a href="https://easyfuncoding.com">EasyFunCoding</a>提供涵盖入门编程到USACO风格算法问题解决的课程。在得克萨斯州，<a href="https://www.momentumlearning.org">Momentum Learning</a>
...
// 个人信息栏
if (location.search == '' || location.search == '?page=contests') {
    $('.panel:contains("Your Account")').html($('.panel:contains("Your Account")').html().
        replaceAll('Your Account', '个人信息').
        replaceAll('Not currently logged in.', '你还没有登录').
        replaceAll('Username:', '用户名：').
        replaceAll('Password:', '密码：').
        replaceAll('Forgot password?', '忘记密码？').
        replaceAll('Login', '登录').
        replaceAll('Register for New Account', '注册一个新账号').
        replaceAll('Welcome,', '你好呀，').
        replaceAll('Edit Account Settings', '编辑个人信息').
        replaceAll('Logout', '登出'))
}

// 注册、编辑信息
if (location.search == '?page=register' || location.search == '?page=editaccount') {
    $('.panel').html($('.panel').html().
        replaceAll('Register here for a personalized username for the USACO contest system.  Your password will be sent to you immediately via email \n      (check your spam folder if you do not see it right away).  You can change your password later by editing your account details.\n      All are welcome to participate in USACO contests and training, including students and non-students, USA and non-USA residents.', 
            '在此处注册USACO竞赛系统的个性化用户名。您的密码将立即通过电子邮件发送给您（如果您没有立即看到垃圾邮件文件夹，请检查它）。您可以稍后通过编辑帐户详细信息来更改密码。欢迎所有人参加USACO竞赛和培训，包括学生和非学生、美国和非美国居民。').
        replaceAll('If you identify as female, you can be among those considered for selection as a finalist to train for the USA team \n      attending the European Girls Olympiad in Informatics (EGOI), assuming you also list USA as your country.  If this is the\n      case, please indicate below that you are EGOI eligible. ', 
            '如果你是女性，并且同时你的国家是美国，你就有资格被考虑为参加欧洲女子信息学奥林匹克（EGOI）的美国代表队培训的决赛选手之一。如果你符合条件，请在下面指出你具备EGOI资格。').
        replaceAll('Note: Please enter your real name, since this is how you will be identified in our contest results.  Fake or unacceptable personal names will not receive contest results and may be deleted at any time without warning!', 
            '注意：请输入您的真实姓名，因为这是我们在比赛结果中识别您的方式。伪造或不可接受的个人姓名将不会收到比赛结果，并可能在没有警告的情况下随时被删除！').
        replaceAll('Create New Account', '创建新账户').
        replaceAll('Edit Account Details', '编辑个人信息').
        replaceAll('Username:', '用户名：').
        replaceAll('Division:', '组别：').
        replaceAll('Email Address:', '邮箱地址：').
        replaceAll('First / Given Name:', '名：').
        replaceAll('(like John or Jane)', '（比如 Fugui、Xiaoyu）').
        replaceAll('Last / Family Name:', '姓：').
        replaceAll('(like Smith)', '（比如 Huang、Wang）').
        replaceAll('School:', '学校').
        replaceAll('Graduation Year:', '毕业年份').
        replaceAll('(set to 9999 if you are past high school / secondary school)', '（如果你已经毕业，请将它设为 9999）').
        replaceAll('Country / Region:', '国家').
        replaceAll('EGOI eligible:', 'EGOI条件符合情况：').
        replaceAll('Not eligible', '不符合').
        replaceAll('Eligible (I identify as female)', '符合（确保你是女性）').
        replaceAll('Password:', '旧密码：').
        replaceAll('New Password:', '新密码：').
        replaceAll('(Leave blank if you don\'t want to change your password)', '（如果你不想修改密码，留空）').
        replaceAll('New Password (Again):', '重复新密码：'))
}
